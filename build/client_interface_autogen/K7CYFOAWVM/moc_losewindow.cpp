...
#include "client/client_interface/losewindow.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_LoseWindow_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject LoseWindow::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_LoseWindow.data,
    qt_meta_data_LoseWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *LoseWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LoseWindow.stringdata0))
